...
<table width="1065"   align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="1065" valign="top"><table width="1065"   align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="30">
          <td colspan="4"  valign="top" style="border-bottom: 1px dashed #CCCCCC;">Favorilerinize Eklediğiniz Tüm Üürnleri Bu Alandan Görüntüleyebilirsiniz.</td>
        </tr>
        <tr height="30">
          <td width="75"   style="background :#FFB336; color: black;"align="center">Resim</td>
          <td width="25"   style="background :#FFB336; color: black;"align="center">Sil</td>
          <td width="865"   style="background :#FFB336; color: black;"align="center">Adı</td>
        ...
        if ( $FavoriSayisi > 0 ) {
          foreach ( $FavoriKayitlari as $FavoriSatirlar ) {
            ...
            if ( $UrununUrunTuru == "Kuruyemis" ) {
              $ResimKlasoruAdi = "Kuruyemis";
            } elseif ( $UrununUrunTuru == "Kayisi" ) {
            ...
            ?>
        <tr height="30">
          <td width="75"  align="center" style="border-bottom: 1px dashed #CCCCCC; "><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($UrunKaydi["id"]);?>"><img src="Resimler/UrunResimleri/<?php echo $ResimKlasoruAdi;?>/<?php echo DonusumleriGeriDondur($UrununResmi);?>" border="0" width="60" height="80"></a></td>
          <td width="50"  align="center" style="border-bottom: 1px dashed #CCCCCC;"><a href="index.php?SK=81&ID=<?php echo DonusumleriGeriDondur($FavoriSatirlar["id"]);?>"><img src="Resimler/Sil20x20.png" border="0"></a></td>
          <td width="415" align="center" style="border-bottom: 1px dashed #CCCCCC;"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($UrunKaydi["id"]);?>" style="color:#646464; text-decoration: none "><?php echo  DonusumleriGeriDondur($UrununAdi);?></a></td>
          <td width="100" align="center" style="border-bottom: 1px dashed #CCCCCC;"><a href="index.php?SK=83&ID=<?php echo DonusumleriGeriDondur($UrunKaydi["id"]);?>" style="color:#646464; text-decoration: none "><?php echo  FiyatBicimlendir(DonusumleriGeriDondur($UrununUrunFiyati));?> <?php echo  DonusumleriGeriDondur($UrununParaBirimi);?></a></td>
        </tr>
        <?php
        }
