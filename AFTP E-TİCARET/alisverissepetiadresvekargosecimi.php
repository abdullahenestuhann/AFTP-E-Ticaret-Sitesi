...
if ( isset( $_SESSION[ "Kullanici" ] ) ) {
  ...
  if ( $StokIcinSepettekiUrunSayisi > 0 ) {
    foreach ( $StokIcinSepettiKayitlar as $StokIcinSepettekiSatirlar ) {
      ...
      $StokIcinUrunVaryantBilgileriSorgusu = $VeritabaniBaglantisi->prepare( "SELECT * FROM urunvaryanlari WHERE id = ? LIMIT 1" );
      ...
      <td width="800" valign="top"><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td colspan="2" align="left"><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr height="50">
                  <td width="25" style="border-bottom: 1px dashed #CCCCCC;" align="left"><input type="radio" name="AdresSec" checked="checked" value="<?php echo DonusumleriGeriDondur($AdresSatirlari["id"]); ?>"></td>
            ...
            <td colspan="2" align="left"><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  ...
                  <td width="260"><table width="260" align="center" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC; margin-bottom: 10px;">
                      ...
                      <tr>
                        <td align="center"><input type="radio" name="KargoSec" <?php if($SecimIcinSayi==1){ ?>checked="checked" <?php } ?> value="<?php echo DonusumleriGeriDondur($KargoKaydi["id"]); ?>"></td>
                      </tr>
                      <tr>
                        <td>&nbsp;</td>
                      </tr>
