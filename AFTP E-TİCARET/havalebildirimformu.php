<table width="1065"   align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" valign="top"><form action="index.php?SK=10" method="post">
        <table width="500"   align="center" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr height="30">
            <td valign="bottom align="left"">Aciklama</td>
          </tr>
          <tr height="30">
            <td valign="top" align="left"><textarea name="Aciklama" class="TextAreaAlanlari"></textarea></td>
          </tr>
          <tr height="40">
            <td align="center"><input type="submit" value="Bildirimi Gönder" class="KirmiziButon"></td>
          </tr>
          <tr height="30">
    ...
    <td valign="top" width="545"><table width="545"   align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="30">
          ...
          <td align="left"><b>Havale / EFT İslemi</b></td>
        </tr>
        <tr height="30">
        ...
        <tr height="30">
          ...
          <td align="left"><b>Bildirim İslemi</b></td>
        </tr>
        <tr height="30">
        ...
        <tr height="30">
          <td colspan="2" align="left">Yönetici ödeme onayından sonra sayfamız üzerinden vermiş olduğunuz sipariş en kısa sürede hazırlanarak kargoya teslim edililr ve tarafınıza ulaştırılır.</td>
        </tr>
      </table></td>
  </tr>
</table>
