...
<table width="1065"   align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="1065" valign="top"><table width="1065"   align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="30">
          <td width="125"   style="background :#FFB336; color: black;"align="center">&nbsp;Puan</td>
          <td width="75"   style="background :#FFB336; color: black;"align="center">Yorum&nbsp;</td>
        </tr>
        <?php
        ...
        if ( $YorumlarSayisi > 0 ) {
          foreach ( $YorumlarKayitlari as $Satirlar ) {
            ...
            ?>
        <tr>
          <td width="75"  align="center" style="border-bottom: 1px dashed #CCCCCC; padding:15px 0px; "valign="top"><img src="Resimler/<?php echo $ResimDosyasi;?>" border="0"></td>
          <td width="415" align="center" style="border-bottom: 1px dashed #CCCCCC;  padding:15px 0px;"valign="top"><?php echo  DonusumleriGeriDondur($Satirlar["YorumMetni"]);?></td>
        </tr>
        <?php
        }
        ...
        <?php
          ...
          ?>
        <tr height="50">
          <td colspan="2" align="left">Sisteme Kayıtlı Yorumunuz Bulunmamaktadır. </td>
        </tr>
        <?php
        }
        ?>
