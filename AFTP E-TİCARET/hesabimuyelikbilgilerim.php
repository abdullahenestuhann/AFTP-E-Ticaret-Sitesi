...
<table width="1065"   align="center" border="0" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td width="500" valign="top"><table width="500"   align="center" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr height="30">
          <td  valign="top" align="left"><?php echo $IsimSoyism   ;?></td>
        </tr>
        <tr height="30">
        ...
        <tr height="30">
          <td  valign="bottom" align="left"><b>Adres</b></td>
        </tr>
        <tr height="30">
          <td  valign="top" align="left"><?php echo $Adres ;?></td>
        </tr>
        <tr height="30">
        ...
        <tr height="30">
          <td  valign="top" align="center"><a href ="index.php?SK=51" class="BilgilerimiGuncelleButonu">Bilgilerimi Güncelle</a></td>
        </tr>
      </table></td>
    <td width="20">&nbsp;</td>
