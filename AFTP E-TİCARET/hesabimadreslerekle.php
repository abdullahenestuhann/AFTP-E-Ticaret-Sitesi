...
<table width="1065"   align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" valign="top"><form action="index.php?SK=71" method="post">
        <table width="500"   align="center" border="0" cellpadding="0" cellspacing="0">
          <tr height="50">
            <td  style="color: #FF9900"><h3>Hesabım > Adresler</h3></td>
          </tr>
          <tr height="30">
            <td  valign="top" style="border-bottom: 1px dashed #CCCCCC;">Tüm Adreslerini görüntüleyebilir ve düzenleyebilirsiniz..</td>
          </tr>
          <tr height="30">
          ...
          <tr height="30">
            <td >Yıldızlı Alanları(*) Doldurmak Zorunludur</td>
          </tr>
          <tr height="40">
            <td colspan="2" align="center"><input type="submit" value="Adresi Kaydet" class="KirmiziButon"></td>
          </tr>
        </table>
      </form></td>
    <td width="20">&nbsp;</td>
