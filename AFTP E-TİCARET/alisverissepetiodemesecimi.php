...
if ( isset( $_SESSION[ "Kullanici" ] ) ) {
  if ( isset( $_POST[ "AdresSec" ] ) ) {
    $GelenAdresSecimi = Guvenlik( $_POST[ "AdresSec" ] );
  } else {
    $GelenAdresSecimi = "";
  }
  if ( isset( $_POST[ "KargoSec" ] ) ) {
    $GelenKargoSecimi = Guvenlik( $_POST[ "KargoSec" ] );
  } else {
    $GelenKargoSecimi = "";
  }
  ...
  <table width="1065" align="center" border="0" cellpadding="0" cellspacing="0">
    <tr>
      <td width="800" valign="top"><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td align="left"><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
                <tr>
