      ...
      <td width="800" valign="top"><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            <td><table width="800" align="center" border="0" cellpadding="0" cellspacing="0">
                ...
                <tr height="40">
                  <td>Kart Türü</td>
                  <td colspan="4"><input type="radio" value="1" name="cardType">
                    Visa
                    <input type="radio" value="2" name="cardType">
                    MasterCard</td>
                </tr>
                <tr height="40">
                  <td>Güvenlik Kodu</td>
                ...
                <tr height="40">
                  <td align="center">&nbsp;</td>
                  <td colspan="4" align="left"><input type="submit" value="Ödeme Yap" class="KirmiziButon" /></td>
                </tr>
              </table></td>
          </tr>
        </table></td>
