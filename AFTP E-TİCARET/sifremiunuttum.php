<table width="1065"   align="center" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td width="500" valign="top"><form action="index.php?SK=38" method="post">
        <table width="500"   align="center" border="0" cellpadding="0" cellspacing="0">
          <tr height="50">
            <td colspan="2" style="color: #FF9900"><h3>Şifremi Unuttum</h3></td>
          </tr>
          <tr height="30">
            <td colspan="2" valign="top" style="border-bottom: 1px dashed #CCCCCC;">Aşağıdan Hesabına Yeni Şifre Oluşturabilirsin.</td>
          </tr>
          <tr height="30">
          ...
          <tr height="40">
            <td colspan="2" align="center"><input type="submit" value="Yeni Şifre Oluştuma Maili Gönder" class="KirmiziButon"></td>
          </tr>
        </table>
      </form></td>
    <td width="20">&nbsp;</td>
