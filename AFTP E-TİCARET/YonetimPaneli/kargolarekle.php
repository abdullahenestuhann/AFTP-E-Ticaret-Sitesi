...
<form action="index.php?SKD=0&SKI=23" method="post" enctype="multipart/form-data">
	<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
		<tr height="70">
			...
			<td width="200" bgcolor="#FF9900" align="right"><a href="index.php?SKD=0&SKI=10" style="color: #FFFFFF; text-decoration: none;">Yeni argo Firması Ekle&nbsp;</a></td>
		</tr>
		<tr height="10">
		...
		<tr>
			<td colspan="2"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
				...
				<tr height="40">
					<td>&nbsp;</td>
					<td>&nbsp;</td>
					<td><input type="submit" value="Banka Hesabı Kaydet" class="KirmiziButon"></td>
				</tr>
			</table></td>
		</tr>
	</table>
