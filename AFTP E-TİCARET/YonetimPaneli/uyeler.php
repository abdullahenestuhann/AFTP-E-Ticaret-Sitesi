...
if(isset($_SESSION["Yonetici"])){
	if(isset($_REQUEST["AramaIcerigi"])){
		...
		$AramaKosulu		=	 " AND (EmailAdresi LIKE '%" . $GelenAramaIcerigi . "%' OR IsimSoyism LIKE '%" . $GelenAramaIcerigi . "%' OR TelefonNumarasi LIKE '%" . $GelenAramaIcerigi . "%' ) ";
			...
			<tr height="80">
				<td colspan="2" style="border-bottom: 1px dashed #CCCCCC;" valign="top"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
					<tr height="30">
						...
						<td width="10"><b>:</b></td>
						<td width="150"><?php echo DonusumleriGeriDondur($Uyeler["IsimSoyism"]); ?></td>
