...
<table width="760" align="center" border="0" cellpadding="0" cellspacing="0">
	<tr height="70">
		...
		<td width="200" bgcolor="#FF9900" align="right"><a href="index.php?SKD=0&SKI=106" style="color: #FFFFFF; text-decoration: none;">Bekleyen Siparişlere Dön&nbsp;</a></td>
	</tr>
	<tr height="10">
	...
	if($SiparislerSayisi>0){
		...
		foreach($SiparislerKayitlari as $SiparisBilgileri){
			if($SiparisBilgileri["UrunTuru"] == "Kuruyemis"){
				$ResimKlasoru	=	"kuruyemis";
			}elseif($SiparisBilgileri["UrunTuru"] == "Kayisi"){
				$ResimKlasoru	=	"kayisi";
			}else{
				$ResimKlasoru	=	"bos";
			}
				...
				<tr height="40">
					<td colspan="3"><table width="750" align="right" border="0" cellpadding="0" cellspacing="0">
						<tr>
							<td width="100">&nbsp;</td>
							<td width="10">&nbsp;</td>
							<td width="540"><input type="submit" value="Gönderi Kodunu İşle ve Siparişi Tamamla" class="YesilButon"></td>
						</tr>
					</table></td>
				</tr>
			</table>
